...
import 'package:one_life/Screens/Donor_Eligibility/components/congratulation_screen.dart';
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Image.asset(
              "assets/images/question_7.png",
            ),
            SizedBox(
              height: size.height * 0.03,
            ),
            Text(
              "Injected recreational drugs in the past 5 years ? ",
              style: TextStyle(
                fontSize: 25,
            ...
            RoundedButton(
              ...
              press: () {
                Navigator.push(
                  // if pressed leads to question congratulation screen
                  context,
                  MaterialPageRoute(
                    builder: (context) {
