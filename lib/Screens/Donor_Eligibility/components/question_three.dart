...
import 'package:one_life/Screens/Donor_Eligibility/components/question_four.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              "Had a tatoo in the last 4 months ? ",
              style: TextStyle(
                fontSize: 25,
            ...
            RoundedButton(
              ...
              press: () {
                Navigator.push(
                  // if pressed leads to question four screen
                  context,
                  MaterialPageRoute(
                    builder: (context) {
                      return QuestionFour();
